...
public class Main : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i <= _gridWidth - 1; i++)
        {
            ...
            {
                target = GameObject.Find("itemcontent");
                GameObject gameObject= Instantiate(_listOfGems[Random.Range(0, _listOfGems.Length)], new Vector3(i, j, 0), Quaternion.identity);
